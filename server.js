...
app.post("/refresh", (req, res, next) => {
  ...
  // If the refresh token is valid, creates a new accessToken and returns it.
...
//Plugin 
// Middleware to authenticate user by verifying cx jwt-token.
...
app.post("/login", (req, res) => {
  ...
  let refreshToken = jwt.sign(user, "refresh", { expiresIn: "60s" });
